...
{
    internal class FlowtideMissingPlanProviderException : FlowtideException
    {
        public FlowtideMissingPlanProviderException()
        {
        }

        public FlowtideMissingPlanProviderException(string? message) : base(message)
        {
        }

...
{
    public class FlowtideMissingConnectorManagerException : FlowtideException
    {
        public FlowtideMissingConnectorManagerException()
        {
        }

        public FlowtideMissingConnectorManagerException(string? message) : base(message)
        {
        }

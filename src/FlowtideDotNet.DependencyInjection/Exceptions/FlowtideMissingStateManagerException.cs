...
{
    internal class FlowtideMissingStateManagerException : FlowtideException
    {
        public FlowtideMissingStateManagerException()
        {
        }

        public FlowtideMissingStateManagerException(string? message) : base(message)
        {
        }

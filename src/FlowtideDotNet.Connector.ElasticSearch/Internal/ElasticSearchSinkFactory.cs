...
{
    internal class ElasticSearchSinkFactory : RegexConnectorSinkFactory
    {
        private readonly FlowtideElasticsearchOptions options;

        public ElasticSearchSinkFactory(string regexPattern, FlowtideElasticsearchOptions options) : base(regexPattern)
        {
        ...
        {
            return new TableLineageMetadata("elasticsearch", writeRelation.NamedObject.DotSeperated, includeSchema ? writeRelation.TableSchema : null);
        }
    }
}

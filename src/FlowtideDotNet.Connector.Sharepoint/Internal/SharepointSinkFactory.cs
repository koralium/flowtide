...
{
    internal class SharepointSinkFactory : RegexConnectorSinkFactory
    {
        private readonly SharepointSinkOptions sharepointSinkOptions;
        private readonly ExecutionMode executionMode;

        public SharepointSinkFactory(string regexPattern, SharepointSinkOptions sharepointSinkOptions, ExecutionMode executionMode) : base(regexPattern)
        {
        ...
        {
            return new TableLineageMetadata("sharepoint", writeRelation.NamedObject.DotSeperated, default);
        }
    }
}

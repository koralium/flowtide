...
export const DiskCacheWriteChart = () => {
    ...
    const memoryQuery = usePromRangeQuery("avg(rate(flowtide_temporary_write_ms_sum[1s])/rate(flowtide_temporary_write_ms_count[1s]))", timespan.start, timespan.end, "5s")

...
{
    internal class ComsosDbSinkFactory : RegexConnectorSinkFactory
    {
        private readonly FlowtideCosmosOptions flowtideCosmosOptions;

        public ComsosDbSinkFactory(string regexPattern, FlowtideCosmosOptions flowtideCosmosOptions) : base(regexPattern)
        {
            this.flowtideCosmosOptions = flowtideCosmosOptions;
        }
        ...
        {
            return new TableLineageMetadata("cosmosdb", writeRelation.NamedObject.DotSeperated, default);
        }
    }
}

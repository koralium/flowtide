...
namespace FlowtideDotNet.Storage.DataStructures
{
        ...
        where T : unmanaged
    {
...
#if DEBUG
        // DIAGNOSTIC - REVERT. Set when the list is handed downstream inside a batch; any mutation
        // after that point is someone holding a reference they should no longer be writing through.
        internal bool _handoffSealed;

        internal void SealForHandoff() => _handoffSealed = true;
#endif
        ...
        {
#if DEBUG
            global::System.Diagnostics.Debug.Assert(!_handoffSealed,
                $"PrimitiveList<{typeof(T).Name}>.{member} mutated a list already handed downstream in a batch.");
#endif
        }

...
{
    internal class StateManagerSimpleClient : IStateManagerClient
    {
        private readonly string m_name;
        private readonly StateManagerSimple stateManager;

        internal StateManagerSimpleClient(string name, StateManagerSimple stateManager)
        {
            this.m_name = name;

...
{
    internal class StateManagerAdvancedClient : IStateManagerClient
    {
        private readonly string m_name;
        private readonly StateManagerAdvanced stateManager;

        internal StateManagerAdvancedClient(string name, StateManagerAdvanced stateManager)
        {
            this.m_name = name;

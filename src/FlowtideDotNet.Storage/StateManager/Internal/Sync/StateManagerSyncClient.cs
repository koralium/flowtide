...
namespace FlowtideDotNet.Storage.StateManager.Internal.Sync
{
    internal class StateManagerSyncClient : IStateManagerClient
    {
            ...
            where TMetadata : class, IStorageMetadata
        {
            ...
            {
                serializer = new CompressedStateSerializer<V>(serializer, stateManager.SerializeOptions.ComressionLevel.HasValue ? stateManager.SerializeOptions.ComressionLevel.Value : 3, memoryAllocator);
            }

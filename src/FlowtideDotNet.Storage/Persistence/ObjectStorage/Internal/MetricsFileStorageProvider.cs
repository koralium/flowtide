...
{
    internal class MetricsFileStorageProvider : IFileStorageProvider
    {
        private readonly IFileStorageProvider _internalProvider;
        ...
        public MetricsFileStorageProvider(Meter meter, IFileStorageProvider internalProvider)
        {

...
namespace FlowtideDotNet.Core.Operators.Exchange
{
    ...
    internal class SubstreamTarget : IExchangeTarget
    {
        ...
        // Drain timeout, named in the rollback warning.
        ...
        /// <summary>
        /// Fetched and acked, or none stored; never released by time.
        /// </summary>
        ...
        public async Task OnFailure(long recoveryPoint)
        {
            ...
            _ready = false;
            _lockSemaphore.Release();
            if (_stopBarrierStored && !_stopBarrierFetched)
            {
                // Never silent, the rollback regenerates them by replay.
                _substreamCommunication.Logger.LogWarning("Target {targetId} is rolled back with {eventCount} events the other substream never fetched within the drain timeout {timeout}, they are regenerated by replay.", _exchangeTargetId, _queue?.Count ?? 0, _stopDrainTimeout);
            }

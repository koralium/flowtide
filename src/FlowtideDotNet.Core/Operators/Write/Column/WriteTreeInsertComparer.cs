...
{
    internal class WriteTreeInsertComparer : IBplusTreeComparer<ColumnRowReference, ColumnKeyStorageContainer>
    {
        private DataValueContainer dataValueContainer;
        private List<KeyValuePair<int, ReferenceSegment?>> columnOrder;

        public WriteTreeInsertComparer(List<KeyValuePair<int, ReferenceSegment?>> comparisonColumns, int columnCount)
        {

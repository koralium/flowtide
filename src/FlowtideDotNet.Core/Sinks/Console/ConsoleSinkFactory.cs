...
{
    internal class ConsoleSinkFactory : RegexConnectorSinkFactory
    {
        public ConsoleSinkFactory(string regexPattern)
            : base(regexPattern)
        {
        }
        ...
        {
            return new TableLineageMetadata("console", writeRelation.NamedObject.DotSeperated, writeRelation.TableSchema);
        }
    }
}

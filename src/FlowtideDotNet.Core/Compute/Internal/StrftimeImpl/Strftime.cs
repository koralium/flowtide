...
namespace FlowtideDotNet.Core.Compute.Internal.StrftimeImpl
{
    /// <summary>
    /// Code taken directly from https://github.com/dotliquid/dotliquid/blob/master/src/DotLiquid/Util/StrFTime.cs
    /// This implementation should probably change later on. But gives support for strftime
    /// </summary>

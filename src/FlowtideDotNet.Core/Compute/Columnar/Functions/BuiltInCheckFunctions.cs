...
namespace FlowtideDotNet.Core.Compute.Columnar.Functions
{
    internal static class BuiltInCheckFunctions
    {
        ...
        private static IDataValue CheckValueImplementation<T1, T2, T3>(T1 value, T2 condition, T3 message, ICheckNotificationReceiver notificationReceiver)
            where T1 : IDataValue
            where T2 : IDataValue
            where T3 : IDataValue
        {
        ...
        private static IDataValue CheckTrueImplementation<T1, T2>(T1 condition, T2 message, ICheckNotificationReceiver notificationReceiver)
            where T1 : IDataValue
            where T2 : IDataValue
        {

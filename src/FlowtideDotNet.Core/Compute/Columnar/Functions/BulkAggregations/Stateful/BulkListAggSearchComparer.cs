...
{
    internal class BulkListAggSearchComparer : IBplusTreeComparer<BulkGroupValueRowReference, BulkGroupValueKeyContainer>
    {
        ...
        public BulkListAggSearchComparer(int groupingKeyLength)
        {

...
namespace FlowtideDotNet.Core.ColumnStore.BoundarySearching
{
    internal static class BoundarySearchString
    {
        ...
        Span<int> buffer)
        {
            ...
            BoundaryStringComparer comparer = new BoundaryStringComparer
            {
                TreeOffsets = (int*)treePointers.secondaryPointer,
                TreeData = (byte*)treePointers.dataPointer,
                InputOffsets = (int*)inputPointers.secondaryPointer,
                InputData = (byte*)inputPointers.dataPointer
            };

            BoundarySearchHybrid<BoundaryStringComparer>.SearchBoundaries(

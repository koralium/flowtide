...
{
    internal class DeltaLakeSinkFactory : RegexConnectorSinkFactory
    {
        private readonly DeltaLakeSinkOptions m_deltaLakeSinkOptions;

        public DeltaLakeSinkFactory(string regexPattern, DeltaLakeSinkOptions deltaLakeSinkOptions) : base(regexPattern)
        {
        ...
        {
            return new DeltaLakeSink(m_deltaLakeSinkOptions, Core.Operators.Write.ExecutionMode.OnCheckpoint, writeRelation, dataflowBlockOptions);
        }
    }
}

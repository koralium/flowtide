...
{
    internal class Int16Encoder : IParquetEncoder
    {
        ...
        public Int16Encoder(FieldPath path)
        {
            _path = path;
        }
        ...
        public void ReadNextData(ref AddToColumnParquet addToColumnFunc)
        {
            ...
            if (val.HasValue)
            {
                addToColumnFunc.AddValue(new Int64Value(val.Value));
            }
            else
            {

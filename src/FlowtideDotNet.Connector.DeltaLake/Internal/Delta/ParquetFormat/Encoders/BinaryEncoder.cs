...
{
    internal class BinaryEncoder : IParquetEncoder
    {
        ...
        public BinaryEncoder(FieldPath path)
        {
            _path = path;
        ...
        {
            _dataField = schema.DataFields.First(x => x.Path.Equals(_path));
        }
        ...
        public void ReadNextData(ref AddToColumnParquet addToColumnFunc)
        {
            ...
            _dataIndex++;
            addToColumnFunc.AddValue(new BinaryValue(val));
        }
        ...
        //public (int nextRepititionLevel, int definitionLevel) Read(int index, ref AddToColumnParquet addToColumnFunc)
        //{
        //    var val = _arr![index];
        ...
        //    if (_dataColumn!.RepetitionLevels != null)
        //    {
        //        repititionLevel = _dataColumn.RepetitionLevels[index];
        //        if (_dataColumn.RepetitionLevels.Length > index + 1)
        //        {
        //            nextLevel = _dataColumn.RepetitionLevels[index + 1];
        //        }
        //    }
        //    if (_dataColumn!.DefinitionLevels != null)
        //    {
        //        definitionLevel = _dataColumn.DefinitionLevels[index];
        //    }

        //    if (val == null)
        //    {
        //        addToColumnFunc.AddValue(NullValue.Instance, repititionLevel);
        //    }
        //    else
        //    {
        //        addToColumnFunc.AddValue(new BinaryValue(val), repititionLevel);
        //    }
        //    return (nextLevel, definitionLevel);
        //}

        //public (int repititionLevel, int nextRepititionLevel, int definitionLevel) ReadRepitionAndDefinition(int index)
        //{
        //    int nextLevel = 0;
        //    int repititionLevel = 0;
        //    int definitionLevel = 0;

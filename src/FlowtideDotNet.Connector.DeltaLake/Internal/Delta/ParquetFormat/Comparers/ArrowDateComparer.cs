...
{
    internal class ArrowDateComparer : IArrowComparer
    {
        ...
        {
            var left = (Date32Array)toFindFrom;
            var right = (Date32Array)toFindIn;
        ...
        {
            var left = (Date32Array)array;
            var right = (Date32Array)otherArray;

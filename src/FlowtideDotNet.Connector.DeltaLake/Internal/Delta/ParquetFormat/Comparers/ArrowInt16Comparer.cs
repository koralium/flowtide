...
{
    internal class ArrowInt16Comparer : IArrowComparer
    {
        ...
        {
            var left = (Int16Array)toFindFrom;
            var right = (Int16Array)toFindIn;
        ...
        {
            var left = (Int16Array)array;
            var right = (Int16Array)otherArray;

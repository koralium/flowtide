...
{
    internal class ArrowDecimalComparer : IArrowComparer
    {
        ...
        {
            var left = (Decimal128Array)toFindFrom;
            var right = (Decimal128Array)toFindIn;
        ...
        {
            var left = (Decimal128Array)array;
            var right = (Decimal128Array)otherArray;

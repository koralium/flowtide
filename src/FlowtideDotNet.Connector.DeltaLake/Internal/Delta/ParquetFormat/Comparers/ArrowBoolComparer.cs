...
{
    internal class ArrowBoolComparer : IArrowComparer
    {
        ...
        {
            var left = (BooleanArray)toFindFrom;
            var right = (BooleanArray)toFindIn;
        ...
        {
            var left = (BooleanArray)array;
            var right = (BooleanArray)otherArray;

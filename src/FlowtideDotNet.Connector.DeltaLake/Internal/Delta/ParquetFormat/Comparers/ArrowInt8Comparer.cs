...
{
    internal class ArrowInt8Comparer : IArrowComparer
    {
        ...
        {
            var left = (Int8Array)toFindFrom;
            var right = (Int8Array)toFindIn;
        ...
        {
            var left = (Int8Array)array;
            var right = (Int8Array)otherArray;

...
{
    internal class ArrowInt64Comparer : IArrowComparer
    {
        ...
        {
            var left = (Int64Array)toFindFrom;
            var right = (Int64Array)toFindIn;
        ...
        {
            var left = (Int64Array)array;
            var right = (Int64Array)otherArray;

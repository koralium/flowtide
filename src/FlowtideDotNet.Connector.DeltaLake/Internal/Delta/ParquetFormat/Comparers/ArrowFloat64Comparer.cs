...
{
    internal class ArrowFloat64Comparer : IArrowComparer
    {
        ...
        {
            var left = (DoubleArray)toFindFrom;
            var right = (DoubleArray)toFindIn;
        ...
        {
            var left = (DoubleArray)array;
            var right = (DoubleArray)otherArray;

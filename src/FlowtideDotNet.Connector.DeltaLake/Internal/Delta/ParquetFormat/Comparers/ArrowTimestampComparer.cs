...
{
    internal class ArrowTimestampComparer : IArrowComparer
    {
        ...
        {
            var left = (TimestampArray)toFindFrom;
            var right = (TimestampArray)toFindIn;
        ...
        {
            var left = (TimestampArray)array;
            var right = (TimestampArray)otherArray;

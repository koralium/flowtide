...
{
    internal class IntegerPartitionEncoder : IParquetEncoder
    {
        private readonly string physicalName;
        private Int64Value? _value;

        public IntegerPartitionEncoder(string physicalName)
        {
        ...
        public void NewBatch(ParquetSchema schema, Dictionary<string, string>? partitionValues)
        {
            ...
            {
                throw new ArgumentException($"Partition value for {physicalName} is not an integer");
            }

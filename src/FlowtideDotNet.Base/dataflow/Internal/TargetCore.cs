    ...
    internal sealed class TargetCore<TInput>
    {
        ...
        private bool HasRoomForMoreOperations
        {
            get
            {
                ...
                return _numberOfOutstandingOperations - _numberOfOutstandingServiceTasks < _dataflowBlockOptions.GetActualMaxDegreeOfParallism();
            }
        }
        ...
        private bool HasRoomForMoreServiceTasks
        {
            get
            {
                ...
                else
                {
                    ...
                    return HasRoomForMoreOperations &&
                           _numberOfOutstandingServiceTasks < _dataflowBlockOptions.GetActualMaxDegreeOfParallism();
                }
            }
        }
        ...
        private void ProcessMessagesLoopCore()
        {
            ...
            KeyValuePair<TInput, long> messageWithId = default;
            try
            {
                        ...
                        TryConsumePostponedMessage(forPostponementTransfer: true, result: out transferMessageWithId))
                    {
                        lock (IncomingLock)
                        {
                            Debug.Assert(
                                ...
                                && _boundingState.OutstandingTransfers <= _dataflowBlockOptions.GetActualMaxDegreeOfParallism(),

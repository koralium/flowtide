...
{
    internal class OpenFgaSinkFactory : RegexConnectorSinkFactory
    {
        private readonly OpenFgaSinkOptions options;

        public OpenFgaSinkFactory(string regexPattern, OpenFgaSinkOptions options) : base(regexPattern)
        {
        ...
        {
            return new TableLineageMetadata("openfga", writeRelation.NamedObject.DotSeperated, default);
        }
    }
}

...
ALTER TABLE [test].[StreamPages]  WITH NOCHECK ADD  CONSTRAINT [FK_StreamPages_Streams] FOREIGN KEY([StreamKey])
REFERENCES [test].[Streams] ([StreamKey]);

ALTER TABLE [test].[StreamPages] CHECK CONSTRAINT [FK_StreamPages_Streams];
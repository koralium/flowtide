...
{
    internal static class AggregateTestParser
    {
        public static AggregateTestCase Parse(string txt)
        {
            ...
            var context = parser.aggFuncTestCase();

            var visitor = new AggregateTestCaseVisitor();

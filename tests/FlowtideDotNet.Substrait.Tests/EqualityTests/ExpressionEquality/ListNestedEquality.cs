...
{
    public class ListNestedEquality
    {
        private ListNestedExpression root;
        private ListNestedExpression clone;
        private ListNestedExpression notEqual;

        public ListNestedEquality()
        {
            ...
            clone = new ListNestedExpression()
            {
                Values = new List<Expression>()
                {
                    new StringLiteral() { Value = "test" }
            ...
            notEqual = new ListNestedExpression()
            {
                Values = new List<Expression>()
                {

...
{
    public class BinaryLiteralEquality
    {
        readonly BinaryLiteral root;
        readonly BinaryLiteral clone;
        readonly BinaryLiteral notEqual;

        public BinaryLiteralEquality()
        {
            root = new BinaryLiteral()
            {
                Value = new byte[] { 84, 79, 32, 65 }
            };
            clone = new BinaryLiteral()
            {
                Value = new byte[] { 84, 79, 32, 65 }
            };
            notEqual = new BinaryLiteral()
            {
                Value = new byte[] { 84, 79, 32, 66 }
            };
        }

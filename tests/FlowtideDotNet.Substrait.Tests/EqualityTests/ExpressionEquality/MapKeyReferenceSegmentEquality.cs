...
{
    public class MapKeyReferenceSegmentEquality
    {
        MapKeyReferenceSegment root;
        MapKeyReferenceSegment clone;
        MapKeyReferenceSegment notEqual;
        public MapKeyReferenceSegmentEquality()
        {
            ...
            clone = new MapKeyReferenceSegment()
            {
                Key = "key1",
                Child = new StructReferenceSegment()
                {
            ...
            notEqual = new MapKeyReferenceSegment()
            {
                Key = "key2",
                Child = new StructReferenceSegment()
                {

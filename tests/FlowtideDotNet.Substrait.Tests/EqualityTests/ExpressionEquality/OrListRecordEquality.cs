...
{
    public class OrListRecordEquality
    {
        readonly OrListRecord root;
        readonly OrListRecord clone;
        readonly OrListRecord notEqual;

        public OrListRecordEquality()
        {

...
{
    public class SortRelationEquality
    {
        readonly SortRelation root;
        readonly SortRelation clone;
        readonly SortRelation notEqual;

        public SortRelationEquality()
        {
            root = new SortRelation()
            {

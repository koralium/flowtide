...
{
    public class BufferRelationEquality
    {
        readonly BufferRelation root;
        readonly BufferRelation clone;
        readonly BufferRelation notEqual;

        public BufferRelationEquality()
        {
            root = new BufferRelation()
            {

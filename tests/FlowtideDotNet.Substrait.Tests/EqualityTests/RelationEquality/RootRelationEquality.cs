...
{
    public class RootRelationEquality
    {
        readonly RootRelation root;
        readonly RootRelation clone;
        readonly RootRelation notEqual;

        public RootRelationEquality()
        {

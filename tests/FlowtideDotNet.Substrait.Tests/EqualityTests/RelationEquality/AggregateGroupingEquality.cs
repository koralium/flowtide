...
{
    public class AggregateGroupingEquality
    {
        readonly AggregateGrouping root;
        readonly AggregateGrouping clone;
        readonly AggregateGrouping notEqual;

        public AggregateGroupingEquality()
        {
            root = new AggregateGrouping()
            {
            ...
            notEqual = new AggregateGrouping()
            {
                GroupingExpressions = new List<Expressions.Expression>()
                {

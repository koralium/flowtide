...
{
    public class SetRelationEquality
    {
        readonly SetRelation root;
        readonly SetRelation clone;
        readonly SetRelation notEqual;

        public SetRelationEquality()
        {
            root = new SetRelation()
            {
            ...
            notEqual = new SetRelation()
            {
                ...
                Operation = SetOperation.MinusMultiset
            };
        }
        ...
        [Fact]
        public void InputsChangedNotEqual()
        {
            clone.Inputs = notEqual.Inputs;
            Assert.NotEqual(root, clone);
        }

        [Fact]
        public void OperationChangedNotEqual()
        {
            clone.Operation = notEqual.Operation;
            Assert.NotEqual(root, clone);
        }

...
SELECT
  TradeID,
  da.SK_BrokerID,
  CAST(timestamp_format(RawCreateDTS, 'yyyyMMdd') as INT) as SK_CreateDateID,
  CAST(timestamp_format(RawCreateDTS, 'yyyyMMdd') as INT) as SK_CreateTimeID,
  CAST(timestamp_format(RawCloseDTS, 'yyyyMMdd') as INT) as SK_CloseDateID,
  CAST(timestamp_format(RawCloseDTS, 'yyyyMMdd') as INT) as SK_CloseTimeID,

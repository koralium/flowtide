...
namespace FlowtideDotNet.TpcDI.Extensions
{
    ...
    {
        public static IConnectorManager AddHrData(this IConnectorManager connectorManager, IFileStorage filesLocation)
        {
            return connectorManager.AddCsvFileSource("hr_raw", new CsvFileOptions()
            {
